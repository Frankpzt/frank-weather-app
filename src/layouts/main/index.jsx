        ...
        aria-labelledby="example-modal-sizes-title-sm">
            ...
            <Modal.Body >
              ...
              <div id="btn_group">
                <div>
                  <Link to="/SearchBar">
                    <Button variant="success" id="add_btn"><h1>Add City</h1></Button>{' '}
                  </Link>
                </div>
                <div >
                  <Link to="/RemoveSection">
                    <Button variant="danger" id="remove_btn"><h1>Remove City</h1></Button>{' '}
                  </Link>
                </div>
              </div>
